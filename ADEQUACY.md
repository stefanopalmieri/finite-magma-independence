...
| 4 | + data forms (`mdata`: cons/car/cdr/pairp/ite arms) — extend `EvP` and the dispatch kit; the 3b(iv) architecture (per-form dispatch lemmas + inversions + master induction) is the template | [open] |
