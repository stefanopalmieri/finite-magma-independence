...
| 3b(iii) | β/application from `mevalEntry`: the first compound simulation (dispatch through `mform`/`mapply`, closure formation and entry), bridge table-level trees → running trees, per-form fuel transformers | [open] |
